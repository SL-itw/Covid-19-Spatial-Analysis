...
legend_scale_housing <- data.frame(
  housing = c(rep(1, 3), rep(2, 3), rep(3, 3)),
...
legend <- ggplot() + 
  geom_tile(
    data = legend_scale_housing,
    aes(x = housing, y = case_rate, fill = color)
  ) + 
  scale_fill_identity() +
...
# save SVG legend
ggsave("/Users/stevenlawrence/Desktop/cumc_github/sl4269.github.io/zipsmap_housing_caserate.svg", plot = legend,
